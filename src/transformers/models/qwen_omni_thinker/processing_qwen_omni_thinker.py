...
"""
Processor class for QwenOmniThinker.
"""
...
class QwenOmniThinkerProcessor(ProcessorMixin):
    r"""
    Constructs a QwenOmniThinker processor.
    [`QwenOmniThinkerProcessor`] offers all the functionalities of [`Qwen2VLImageProcessor`], [`WhisperFeatureExtractor`], and [`Qwen2TokenizerFast`]. See the
    [`~QwenOmniThinkerProcessor.__call__`] and [`~QwenOmniThinkerProcessor.decode`] for more information.
        ...
        **kwargs: Unpack[QwenOmniThinkerProcessorKwargs],
        ...
        if videos is not None:
            ...
            videos_inputs["video_second_per_grid"] = [
                fps[i] / self.image_processor.temporal_patch_size for i in range(len(fps))
            ]
        ...
        return BatchFeature(data={**texts_inputs, **images_inputs, **videos_inputs, **audios_inputs})
