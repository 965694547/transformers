...
@require_torch
@require_torchaudio
class QwenOmniThinkerProcessorTest(ProcessorTesterMixin, unittest.TestCase):
    processor_class = QwenOmniThinkerProcessor
    ...
    def setUp(self):
        ...
        processor = QwenOmniThinkerProcessor.from_pretrained(
            "/home/xj_intern_data/malinhan.mlh/s_proj/thinker_talker/Qwen2Omni-v2024.12.12-7B-ThinkerSFT_iter_0000500/0102_convert_thinker_zf"
        )
    ...
    def test_save_load_pretrained_default(self):
        ...
        processor = QwenOmniThinkerProcessor(
            image_processor=image_processor, feature_extractor=feature_extractor, tokenizer=tokenizer
        )
        processor.save_pretrained(self.tmpdirname)
        processor = QwenOmniThinkerProcessor.from_pretrained(self.tmpdirname, use_fast=False)
